				...
				<div class="tab_content_container"> 
					...
					<div id="tab2" class="tab_content">
						<div class="form label-inline uniform">
							...
							<div class="field">用户编码<input /> <button class="btn btn-small">确定</button></div>
							<div class="field">用户姓名<input disabled="disabled" /></div>
							<div class="field">用户电话<input disabled="disabled" /></div>
							<div class="field">用户表径<input disabled="disabled" /></div>
							<div class="field">用户地址<input disabled="disabled" size="50" /></div>
