	...
	<div id="content" class="xgrid" >
		...
		<div class="x12">
			...
			<div class="searchUserDiv">
				用户编码 <input id="no" name="userNo" value=""  onblur="ft()"/>
				用户简码 <input name="abc" value="" />
				用户姓名 <input name="userName" value=""/>
				联系电话 <input id="ph" name="phone" value=""  onblur="ft()"/>
				家庭住址 <input name="address" value=""/>
			...
			<div class="form label-inline uniform">
				...
				<div class="field"><label for="id">用户编码</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="" /></div>
				<div class="field"><label for="name">原用户姓名</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="" /></div>
				<div class="field"><label for="name">原联系电话</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="" /></div>
				<div class="field"><label for="name">原短信电话</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="" /></div>
				<div class="field"><label for="name">原联系地址</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="" /></div>
				
				
				
				<div class="field"><label for="name">新用户姓名</label> <input id="name" name="lname" size="50" type="text" class="medium" value="" /></div>
				<div class="field"><label for="name">新联系电话</label> <input id="name" name="lname" size="50" type="text" class="medium" value="" /></div>
				<div class="field"><label for="name">新短信电话</label> <input id="name" name="lname" size="50" type="text" class="medium" value="" /></div>
				<div class="field"><label for="name">新联系地址</label> <input id="name" name="lname" size="50" type="text" class="medium" value="" /></div>
				

				<div class="buttonrow">
					<button class="btn">过户</button>
				</div>
