	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<div class="form label-inline uniform">
				...
				<div class="field"><label for="id">抄表年月</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="201312" /></div>
				
				<div class="field"><label for="id">辖区</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="城东区" /></div>
				
				<div class="field"><label for="id">表册</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="城区#1" /></div>
				
				<div class="field"><label for="name">任务分配给</label> 
					<select class="medium">
						<option>马云</option>
						<option>马化腾</option>
						<option>李彦宏</option>
