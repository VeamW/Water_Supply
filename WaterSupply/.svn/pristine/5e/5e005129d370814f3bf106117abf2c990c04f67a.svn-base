...
<div id="wrapper">
	...
	<div id="content" class="xgrid" >
		...
		<div class="x12">
			...
			<div class="height40">
				<button class="btn-icon btn-blue btn-check" onClick="location.href = 'rd_changePreAmount_add.jsp';"><span></span>添加底码修正记录</button>
			</div>
			...
			<table class="data display">
				...
				<tbody>
					...
					<tr class="even">
						...
						<td>换表X8-357，重置表码数</td>
					</tr>
					<tr class="odd"> <!-- 查询不到数据 -->
						<td class="center" colspan="8">
							用户【0100000987 张三】没有任何底码修正记录。
						</td>
					</tr>
					</tbody>
				</table>
