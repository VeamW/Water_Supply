...
<div id="wrapper">
	...
	<div id="content" class="xgrid" >
		...
		<div class="x12">
			...
			<h2>快捷过户</h2>
			<form action="/Water_Project/us/use" method="post">
			<div class="searchUserDiv">
				用户编码 <input id="no" name="userNo" value="${user.userNo}" />
			...
			<form id="userchangeForm" action="/Water_Project/us/updateXG?useron=${user.userNo}" method="post"  onsubmit="return search()">
			<div class="form label-inline uniform">
				<h3 style="width:50%;">快捷过户</h3>
				<div class="field"><label for="id">用户编码</label> <input id="id" name="" size="50" type="text" class="medium" disabled="disabled" value="${user.userNo}" /></div>
				<div class="field"><label for="name">原用户姓名</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="${user.userName}" /></div>
				<div class="field"><label for="name">原联系电话</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="${user.phone}" /></div>
				<div class="field"><label for="name">原短信电话</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="${user.smsPhone}" /></div>
				<div class="field"><label for="name">原联系地址</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="${user.address}" /></div>
				
				
				
				<div class="field"><label for="name">新用户姓名</label> <input id="nam" name="userName" size="50" type="text" class="medium" value="" /></div>
				<div class="field"><label for="name">新联系电话</label> <input id="ph" name="phone" size="50" type="text" class="medium" value="" /></div>
				<div class="field"><label for="name">新短信电话</label> <input id="sm" name="smsPhone" size="50" type="text" class="medium" value="" /></div>
				<div class="field"><label for="name">新联系地址</label> <input id="ad" name="address" size="50" type="text" class="medium" value="" /></div>
