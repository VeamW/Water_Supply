...
<div id="wrapper">
	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<p><button class="btn-icon btn-plus" onClick="location='sys_area_add.jsp';"><span></span>添加抄表辖区</button></p>
			...
			<table class="data display">
					...
					<tbody>
						<tr class="odd gradeX">
							...
							<td>复兴路口以东</td>
							<td class="center">
								<button class="btn-icon btn-small btn-blue btn-star" onClick="location='sys_area_add.jsp';"><span></span>修改</button>  
