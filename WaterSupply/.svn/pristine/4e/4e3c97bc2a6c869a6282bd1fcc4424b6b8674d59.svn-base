	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<div class="form label-inline uniform">
				...
				<div class="field"><label for="id">交票时间</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="2014-01-23" /></div>
				
				<div class="field"><label for="name">交票人</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="输入发票号码后，Ajax查询显示" /></div>
				
				<div class="field"><label for="name">收票人</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="诸葛发财" /></div>
				
				<div class="field"><label for="name">发票类型</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="填入发票号码后，Ajax查询" /></div>
				
				<div class="field"><label for="name">发票起始号码</label> <input id="name" name="lname" size="50" type="text" class="medium" /></div>
				
				<div class="field"><label for="name">发票终止号码</label> <input id="name" name="lname" size="50" type="text" class="medium" /></div>
				
				<div class="field"><label for="name">发票张数</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="填入发票号码后，动态显示" /></div>
