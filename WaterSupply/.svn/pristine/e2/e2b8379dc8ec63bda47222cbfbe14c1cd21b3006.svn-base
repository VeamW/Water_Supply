...
<head> 
	...
	<title>Widgets | Dashboard Admin</title> 
...
<div id="wrapper">
	...
	<div id="header">
		...
		<div class="content_pad">
			...
			<ul id="nav">
				...
				<li class="nav_current nav_icon"><a href="../pages/widgets.jsp"><span class="ui-icon ui-icon-gear"></span>Widgets</a></li>
	...
	<div id="masthead">
		...
		<div class="content_pad">
			...
			<div id="bread_crumbs">
				...
				<a href="javascript:;" class="current_page">Widgets</a>				
			 </div> <!-- #bread_crumbs -->
	...
	<div id="content" class="xgrid">
		...
		<div class="x6">
			...
			<a href="#facebox_content" rel="facebox" class="btn btn-small btn-orange">Open Modal Window</a>
		...
		<div class="x6">
				...
				<div class="accordion_container">
					<h2 class="accordion_panel"><a href="#">Panel #1</a></h2> 
					...
					<h2 class="accordion_panel"><a href="#">Panel #3</a></h2> 
					...
					<h2 class="accordion_panel"><a href="#">Panel #4</a></h2> 
