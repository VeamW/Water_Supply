			...
			<table class="data display">
					...
					<tbody>
						...
						<tr class="odd">
							...
							<td>2014-02-18</td>
							<td>许五多</td>
							<td><button class="btn-icon btn-small btn-blue btn-check" onClick="location.href = 'be__auditForm.jsp';"><span></span>处理</button></td>
						</tr>
						<tr class="even">
							...
							<td>2014-02-18</td>
							<td>中国农业银行解放路支行</td>
							<td><button class="btn-icon btn-small btn-blue btn-check" onClick="location.href = 'be__saveForm.jsp';"><span></span>处理</button></td>
						</tr>
						<tr class="odd">
						...
						<tr class="even">
							...
							<td>2014-02-18</td>
							<td>许八多</td>
							<td><button class="btn-icon btn-small btn-blue btn-check" onClick="location.href = 'be__contractForm.jsp';"><span></span>处理</button></td>
						</tr>
						<tr class="odd">
