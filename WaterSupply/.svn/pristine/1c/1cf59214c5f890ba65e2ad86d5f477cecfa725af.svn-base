	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<div class="form label-inline uniform">
				...
				<div class="field"><label for="id">员工ID</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="自动生成" /></div>
				
				<div class="field"><label for="name">员工工号</label> <input id="name" name="lname" size="50" type="text" class="medium" /></div>
				
				<div class="field"><label for="name">员工姓名</label> <input id="name" name="lname" size="50" type="text" class="medium" /></div>
				
				<div class="field"><label for="name">密码</label> <input id="name" name="lname" size="50" type="password" class="medium" /></div>
				
				<div class="field"><label for="type">所属部门</label> <select id="type" class="medium" >
										<option>经理室</option>
										<option>生技室</option>
										<option>财务室</option>
