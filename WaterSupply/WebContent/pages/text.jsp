...
<head> 
	...
	<title>Text Styles | Dashboard Admin</title> 
	...
	<style type="text/css" media="screen">
		button,
		a.btn-mini { margin-bottom: 1.5em !important; margin-right: .5em !important; }
	</style>
...
<div id="wrapper">
	...
	<div id="masthead">
		...
		<div class="content_pad">
			...
			<h1 class="">Text Styles</h1>
			
			<div id="bread_crumbs">
				<a href="../dashboard.jsp">Home</a> / 
				<a href="javascript:;" class="current_page">Text Styles</a>				
			 </div> <!-- #bread_crumbs -->
	...
	<div id="content" class="xgrid">
		...
		<div class="x5 a1"><h2>Heading Styles</h2>
				<h1>Level 1 heading</h1>
				<p>Sed scelerisque sagittis lorem. Phasellus sodales. Nulla urna justo, vehicula in, suscipit nec, molestie sed, tellus. Quisque justo. Nam libero leo, elementum in.</p>
		...
		<div class="x6"><h2>Button Styles</h2>
		...
		<div class="x6"><h2>Tables Styles</h2>
...
<tr class="odd gradeX">
		...
		<div class="p1 x5"><h2>List Styles</h2>
