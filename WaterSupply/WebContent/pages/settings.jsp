...
<head> 
	...
	<title>Settings | Dashboard Admin</title> 
...
<div id="wrapper">
	...
	<div id="masthead">
		...
		<div class="content_pad">
			...
			<div id="bread_crumbs">
				...
				<a href="javascript:;" class="current_page">Settings</a>				
			 </div> <!-- #bread_crumbs -->
	...
	<div class="accordion_container">	
				...
				<h2 class="accordion_panel"><a href="#">Change Password</a></h2> 
	<div class="accordion_content"> 
		<div class="block"> 
			
			<form action="/submit" method="post" class="form label-inline">
	
							<div class="field"><label for="password">Old Password: </label> <input id="password" name="password" size="50" type="text" class="medium" /></div>
				
							<div class="field"><label for="password2">New Password: </label> <input id="password2" name="password2" size="50" type="text" class="medium" /></div>
							<div class="field"><label for="password3">Retype Password: </label> <input id="password3" name="password3" size="50" type="text" class="medium" /></div>
				...
				<h2 class="accordion_panel"><a href="#">Personal Information</a></h2> 
	<div class="accordion_content"> 
		<div class="block"> 
			<form action="/submit" method="post" class="form label-inline uniform">
							...
							<div class="field clearfix">								
								...
								<input style="opacity: 0;" id="upload" class="file" type="file" />								
							</div>
							...
							<br />
							<div class="buttonrow">
								<button class="btn btn-orange">Update Information</button>
							</div>
	...
	<h2 class="accordion_panel"><a href="#">More Settings</a></h2> 
	<div class="accordion_content"> 
		<div class="block"> 
	...
	<h2 class="accordion_panel"><a href="#">Even More Settings</a></h2> 
	<div class="accordion_content"> 
		<div class="block"> 
			<p>Consequat te olim letalis premo ad hos olim odio olim indoles ut venio iusto. Euismod, sagaciter diam neque antehabeo blandit, jumentum transverbero luptatum. Lenis vel diam praemitto molior facilisi facilisi suscipere abico, ludus, at. Wisi suscipere nisl ad capto comis esse, autem genitus. Feugiat immitto ullamcorper hos luptatum gilvus eum. Delenit patria nunc os pneum acsi nulla magna singularis proprius autem exerci accumsan. </p> 
