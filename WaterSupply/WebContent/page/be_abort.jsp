	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<div class="form label-inline uniform">
				...
				<div class="field"><label for="id">工单号</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="B1-20111223-0011" /></div>
				<div class="field"><label for="id">工单类型</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="新立户" /></div>
				<div class="field"><label for="id">用户姓名</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="杨天雷" /></div>
				<div class="field"><label for="id">用户地址</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="新开发区步行街405号" /></div>
				<div class="field"><label for="id">联系人</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="杨天雷" /></div>
				<div class="field"><label for="id">联系电话</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="18458493458" /></div>
				<div class="field"><label for="id">当前流程</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="施工竣工" /></div>
				<div class="field"><label for="id">最后操作人</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="马云" /></div>
				<div class="field"><label for="id">最后操作时间</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="2014-01-17" /></div>
				<div class="field"><label for="id">已交费</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="否" /></div>
