...
<div id="wrapper">
	...
	<div id="masthead">
		<div>
			<span id="pagetitle"><a href="javascript:;">底码修正</a></span>
	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<div class="form label-inline uniform">
				...
				<div class="field"><label for="id">修正前底码数</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="2079" /></div>
				<div class="field"><label for="id">修正后底码数</label> <input id="id" name="fname" size="50" type="text" class="medium" value="" /></div>
				<div class="field"><label for="id">操作人</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="李彦宏" /></div>
				<div class="field"><label for="id">操作日期</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="2014年01月22日" /></div>
