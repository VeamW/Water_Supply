	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<div class="form label-inline uniform">
				...
				<div class="field"><label for="id">用户姓名</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="张三" /></div>
				<div class="field"><label for="id">上次底码数</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="2079" /></div>
				<div class="field"><label for="id">本次底码数</label> <input id="id" name="fname" size="50" type="text" class="medium" value="" /></div>
				<div class="field"><label for="id">实用水量</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="" /></div>
				<div class="field"><label for="id">抄表人</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="李彦宏" /></div>
				<div class="field"><label for="id">抄表日期</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="2014年01月22日" /></div>
