			...
			<table class="data display">
					...
					<tbody>
						<tr class="odd">
							...
							<td>2014-02-18</td>
							<td>许三多</td>
							<td><button class="btn-icon btn-small btn-blue btn-check" onClick="location.href = 'be__request1.jsp';"><span></span>处理</button></td>
						</tr>
						<tr class="even">
							...
							<td>2014-02-18</td>
							<td>许四多</td>
							<td><button class="btn-icon btn-small btn-blue btn-check" onClick="location.href = 'be__request2.jsp';"><span></span>处理</button></td>
						</tr>
						<tr class="odd">
							...
							<td>2014-02-18</td>
							<td>许五多</td>
							<td><button class="btn-icon btn-small btn-blue btn-check" onClick="location.href = 'be__request3.jsp';"><span></span>处理</button></td>
						</tr>
						<tr class="even">
							...
							<td>2014-02-18</td>
							<td>中国农业银行解放路支行</td>
							<td><button class="btn-icon btn-small btn-blue btn-check" onClick="location.href = 'be__request4.jsp';"><span></span>处理</button></td>
						</tr>
						<tr class="odd">
							...
							<td>2014-02-18</td>
							<td>中国联通广东路营业厅</td>
							<td><button class="btn-icon btn-small btn-blue btn-check" onClick="location.href = 'be__request5.jsp';"><span></span>处理</button></td>
						</tr>
						<tr class="even">
							...
							<td>2014-02-18</td>
							<td>许八多</td>
							<td><button class="btn-icon btn-small btn-blue btn-check" onClick="location.href = 'be__request6.jsp';"><span></span>处理</button></td>
						</tr>
						<tr class="odd">
							...
							<td>2014-02-18</td>
							<td>许蛮多</td>
							<td><button class="btn-icon btn-small btn-blue btn-check" onClick="location.href = 'be__request7.jsp';"><span></span>处理</button></td>
						</tr>
						<tr class="even">
