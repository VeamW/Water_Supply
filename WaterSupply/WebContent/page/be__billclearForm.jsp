...
<div id="wrapper">	
	...
	<div id="masthead">
		<div>
			<span id="pagetitle"><a href="javascript:;">水费清算</a></span>
	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<h2>
				水费清算 - <a href="<%=path %>/page/be_orderInfo.jsp?id=B1-20140105-0001" target="orderInfo">B1-201412-0003</a>
			...
			<div class="buttonrow">
				...
				<button class="btn-icon btn-arrow-right btn-blue" 
					onclick="alert('水费未结清，不能发送，请先结清水费之后再发送。');"><span></span>发送</button>
			</div>
			...
			<tbody>
				...
				<tr>
					<td>原用户电话</td>
					<td><input readonly="readonly" value="13732718344" /></td>
				</tr>
				<tr>
					<td>原用户地址</td>
					<td><input readonly="readonly" value="城南区解放南路昌义小区9栋2号" /></td>
				</tr>
				<tr>
					<td>原用户余额</td>
				...
				<tr>
					<td>原用户欠费</td>
					<td><input readonly="readonly" class="right" value="192.22" /> 元</td>
				</tr>
