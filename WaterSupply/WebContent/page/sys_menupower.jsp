	...
	<div id="content" class="xgrid">
		...
		<p>
			<div style="float:left;">
				<button class="btn-icon btn-star" onClick="location='sys_menupower_set.jsp';"><span></span>批量设置菜单权限</button>
			</div>
			...
			<table class="data display">
				...
				<tbody>
					<tr class="odd gradeX">
						...
						<td>&nbsp;</td>
						<td class="center">
							<button class="btn-icon btn-small btn-blue btn-star" onClick="location='sys_menupower_set.jsp';"><span></span>设置菜单权限</button>
						</td>
					</tr>
