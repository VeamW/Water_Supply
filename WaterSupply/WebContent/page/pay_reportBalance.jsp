...
<div id="wrapper">
	...
	<div id="content" class="xgrid" >
		...
		<div class="x12">
			...
			<div class="searchDiv">
				<div style="float:left;">预收金额大于 <input value="5000" /> </div>
			...
			<div class="height24">
				<div style="float:left;width:160px;">总户数：231 户</div>
				<div style="float:left;">总预收金额：5830123.45 元</div>
			</div>
			<table class="report">
				<thead>
					<tr>
				...
				<tbody>
					<tr>
						...
						<td class="right">3495.00 元</td>
						<td class="left">张三</td>
						<td class="left">城东区忠孝东路小忠孝道跪拜巷子尽孝院子3号</td>
						<td class="left">0731-83749388</td>
					</tr>
					<tr>
						<td class="center">0100000384</td>
						<td class="right">13495.00 元</td>
						<td class="left">李四四</td>
						<td class="left">旧城区中兴前路胡人老街老鼠巷194号3楼</td>
						<td class="left">0731-12312312</td>
					</tr>
					<tr>
						<td class="center">0100048033</td>
						<td class="right">1233.00 元</td>
						<td class="left">钱小马</td>
						<td class="left">新开发区国际IT中心华瑞国际总部办公楼</td>
						<td class="left">0731-58869920</td>
					</tr>
					<tr>
						<td class="center">0100049001</td>
						<td class="right">9999.99 元</td>
						<td class="left">李奥巴马</td>
						<td class="left">城北区华瑞大学校区内学生宿舍489号</td>
						<td class="left">0731-91191199</td>
					</tr>
					<tr>
						<td class="center">0100000987</td>
						<td class="right">3495.00 元</td>
