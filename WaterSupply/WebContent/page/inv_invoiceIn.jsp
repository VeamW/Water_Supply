	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<div class="form label-inline uniform">
				...
				<div class="field"><label for="id">入库时间</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="2014-01-23" /></div>
				
				<div class="field"><label for="name">入库人员</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="诸葛发财" /></div>
				
				<div class="field"><label for="name">发票类型</label> <select class="medium">
						<option>普通发票</option>
						<option>增值税发票</option>
					</select></div>
