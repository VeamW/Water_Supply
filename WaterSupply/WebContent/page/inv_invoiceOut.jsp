	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<div class="form label-inline uniform">
				...
				<div class="field"><label for="id">出库时间</label> <input id="id" name="fname" size="50" type="text" class="medium" disabled="disabled" value="2014-01-23" /></div>
				
				<div class="field"><label for="name">出库人</label> <input id="name" name="lname" size="50" type="text" class="medium" disabled="disabled" value="诸葛发财" /></div>
				
				<div class="field"><label for="name">领用人</label> <select class="medium">
						<option>马云</option>
						<option>马化腾</option>
						<option>李彦宏</option>
						<option>雷军</option>
