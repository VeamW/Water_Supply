...
<div id="wrapper">
	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<p><button class="btn-icon btn-plus" onClick="location='sys_meterType_add.jsp';"><span></span>添加水表型号</button></p>
			...
			<table class="data display">
					...
					<tbody>
						<tr class="odd gradeX">
							...
							<td>&nbsp;</td>
							<td class="center">
								<button class="btn-icon btn-small btn-blue btn-star" onClick="location='sys_meterType_add.jsp';"><span></span>修改</button>  
